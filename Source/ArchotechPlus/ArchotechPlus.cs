...
namespace ArchotechPlus
{
    public class ArchotechPlus : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            listingStandard.CheckboxLabeled("Regenerator can de-age", ref ArchotechPlusSettings.RegeneratorDeAge,
                "The regenerator will change the age of the pawn when used.\nDefault: Enabled");
            ...
            listingStandard.Gap();
            listingStandard.CheckboxLabeled("Regenerator Can Resurrect",
                ref ArchotechPlusSettings.RegeneratorResurrects,
                "The level 3 regenerator implant will attempt to resurrect the user if this is enabled.\nDefault: Enabled");
            if (ArchotechPlusSettings.RegeneratorResurrects)
            {
                listingStandard.Label("\tMax Resurrection Charges:", -1,
                    "The number of resurrecting charges that the level 3 regenerator will be able to accumulate over time.\nDefault: 1");
                listingStandard.Gap(Text.LineHeight / 2);
            ...
            listingStandard.Label(
                (ArchotechPlusSettings.HealingRange.min / 24 != 0
                    ? $"{ArchotechPlusSettings.HealingRange.min / 24} Days"
                    : "")
                + (ArchotechPlusSettings.HealingRange.min / 24 != 0 && ArchotechPlusSettings.HealingRange.min % 24 != 0
                    ? ", "
                    : "")
                + (ArchotechPlusSettings.HealingRange.min % 24 != 0
                    ? $"{ArchotechPlusSettings.HealingRange.min % 24} Hours"
                    : "")
                + " - "
                + (ArchotechPlusSettings.HealingRange.max / 24 != 0
                    ? $"{ArchotechPlusSettings.HealingRange.max / 24} Days"
                    : "")
                + (ArchotechPlusSettings.HealingRange.max / 24 != 0 && ArchotechPlusSettings.HealingRange.max % 24 != 0
                    ? ", "
                    : "")
                + (ArchotechPlusSettings.HealingRange.max % 24 != 0
                    ? $"{ArchotechPlusSettings.HealingRange.max % 24} Hours"
                    : ""));
            if (ArchotechPlusSettings.RegeneratorResurrects)
            {
                listingStandard.Gap(Text.LineHeight * 3.25f);
                listingStandard.Label(
                    (ArchotechPlusSettings.ResurrectionRange.min / 24 != 0
                        ? $"{ArchotechPlusSettings.ResurrectionRange.min / 24} Days"
                        : "")
                    + (ArchotechPlusSettings.ResurrectionRange.min / 24 != 0 &&
                       ArchotechPlusSettings.ResurrectionRange.min % 24 != 0
                        ? ", "
                        : "")
                    + (ArchotechPlusSettings.ResurrectionRange.min % 24 != 0
                        ? $"{ArchotechPlusSettings.ResurrectionRange.min % 24} Hours"
                        : "")
                    + " - "
                    + (ArchotechPlusSettings.ResurrectionRange.max / 24 != 0
                        ? $"{ArchotechPlusSettings.ResurrectionRange.max / 24} Days"
                        : "")
                    + (ArchotechPlusSettings.ResurrectionRange.max / 24 != 0 &&
                       ArchotechPlusSettings.ResurrectionRange.max % 24 != 0
                        ? ", "
                        : "")
                    + (ArchotechPlusSettings.ResurrectionRange.max % 24 != 0
                        ? $"{ArchotechPlusSettings.ResurrectionRange.max % 24} Hours"
                        : ""));
            }
